    ...
    <div className="homepage">
      <section className="homepage__intro">
        ...
        <p className="homepage__description">
          I'm a software developer with a passion I'm a software developer with a passion for creating engaging web applications. Explore my projects below.
        </p>
      </section>
      
      <section className="homepage__projects">
        {/* <h2 className="homepage__section-title">My Projects</h2> */}
        <div className="homepage__project-list">
          <Link to="/project/mnema" className="homepage__project-card">
            <img src={mnemaImg} alt="Mnema" className="homepage__project-image" />
            <h3 className="homepage__project-title">Mnema</h3>
            <p className="homepage__project-summary">A language learning application using mnemonics and AI. A language learning application using mnemonics and AI.</p>
          </Link>
          <Link to="/project/brainflix" className="homepage__project-card">
            <img src={brainflixImg} alt="Brainflix" className="homepage__project-image" />
            <h3 className="homepage__project-title">Brainflix</h3>
            <p className="homepage__project-summary">A video streaming platform built with React. A language learning application using mnemonics and AI.</p>
          </Link>
          <Link to="/project/bandsite" className="homepage__project-card">
            <img src={bandsiteImg} alt="Bandsite" className="homepage__project-image" />
            <h3 className="homepage__project-title">Bandsite</h3>
            <p className="homepage__project-summary">A band website showcasing music and events. A language learning application using mnemonics and AI.</p>
          </Link>
      ...
      <section className="homepage__team-projects">
        {/* <h2 className="homepage__section-title">Projects Created in Teamwork</h2> */}
        {/* <div className="homepage__project-list">
          <Link to="/project/nyt-daily-bites" className="homepage__project-card">
            <img src={nytImg} alt="New York Times Daily Bites" className="homepage__project-image" />
            <h3 className="homepage__project-title">New York Times Daily Bites</h3>
